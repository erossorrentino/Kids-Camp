...
export const BIOMES = {
  ...
  arctic:     { sky:0xc8d8e4, fogCol:0xdfeaf2, fog:[60, 520], sun:0xeef6ff, sunI:2.4, amb:0xa8c0d4, ambI:1.3,
                ground:0xdce8f0, accent:0x7cd8ff, hazeCol:0xeaf4fa, label:'ARCTIC' },
  volcanic:   { sky:0x2a1210, fogCol:0x5a2418, fog:[50, 460], sun:0xff9a55, sunI:1.7, amb:0x7a2a18, ambI:1.0,
                ground:0x2e2422, accent:0xff4a1f, hazeCol:0x8e3a20, label:'VOLCANIC' },
  ...
  orbital:    { sky:0x05070f, fogCol:0x0a1020, fog:[200, 1400], sun:0xffffff, sunI:3.4, amb:0x1a2440, ambI:0.5,
                ground:0x2a3038, accent:0x49d6ff, hazeCol:0x101828, label:'ORBITAL' },
  citynight:  { sky:0x0c1018, fogCol:0x141c28, fog:[60, 520], sun:0x9fb4d8, sunI:0.8, amb:0x1f2a3a, ambI:0.9,
                ground:0x23282e, accent:0xff4de0, hazeCol:0x1a2434, label:'NIGHT CITY' },
  ...
  underwater: { sky:0x0a2a3a, fogCol:0x0f3a4e, fog:[25, 260], sun:0x9fe8ff, sunI:1.4, amb:0x1a4a5e, ambI:1.2,
                ground:0x2a4a52, accent:0x5ce8ff, hazeCol:0x1a5a70, label:'ABYSSAL' },
